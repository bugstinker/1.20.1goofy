...
import net.dragm.goofymod.block.entity.IncubatorBlockEntity;
...
public class IncubatorMenu extends AbstractContainerMenu {
    ...
    public IncubatorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 152, 17));
            this.addSlot(new SlotItemHandler(iItemHandler, 3, 44, 17));
            this.addSlot(new SlotItemHandler(iItemHandler, 4, 8, 17));
            this.addSlot(new SlotItemHandler(iItemHandler, 5, 80, 63));
            this.addSlot(new SlotItemHandler(iItemHandler, 6, 116, 63));
            this.addSlot(new SlotItemHandler(iItemHandler, 7, 152, 63));
            this.addSlot(new SlotItemHandler(iItemHandler, 8, 44, 63));
            this.addSlot(new SlotItemHandler(iItemHandler, 9, 8, 63));
        });
    ...
    public int getScaledProgress() {
        ...
        int progressArrowSize = 21; // This is the height in pixels of your arrow
